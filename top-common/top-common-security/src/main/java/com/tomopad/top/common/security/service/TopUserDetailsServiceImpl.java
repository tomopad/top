...
import com.tomopad.top.admin.api.feign.RemoteUserService;
...
public class TopUserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) {
		...
		if (cache != null && cache.get(username) != null) {
			return (TopUser) cache.get(username).get();
		}
	...
	private UserDetails getUserDetails(R<UserInfo> result) {
		...
		// 构造security用户
		return new TopUser(user.getUserId(), user.getDeptId(), user.getUsername(),
