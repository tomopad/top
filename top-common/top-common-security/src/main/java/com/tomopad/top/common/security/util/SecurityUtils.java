package com.tomopad.top.common.security.util;
...
public class SecurityUtils {
     ...
     * 获取用户
     */
    public TopUser getUser(Authentication authentication) {
        Object principal = authentication.getPrincipal();
        if (principal instanceof TopUser) {
            return (TopUser) principal;
        }
        return null;
    }
