package com.tomopad.top.common.fegin.ext;
 ...
 */
@Slf4j
public class TopSentinelInvocationHandler implements InvocationHandler {
    ...
    TopSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch, FallbackFactory fallbackFactory) {
        this.target=target;
    ...
    TopSentinelInvocationHandler(Target<?> target,Map<Method,InvocationHandlerFactory.MethodHandler> dispatch){
        this.target=target;
        this.dispatch = checkNotNull(dispatch, "dispatch");
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler){
            TopSentinelInvocationHandler other = (TopSentinelInvocationHandler)obj;
